...
/**
 * Created by MattPhilpot on 7/21/2017.
 */
...
class CircleImageView : ImageView {
    ...
    @Deprecated("Use {@link #setBorderColor(int)} instead", ReplaceWith("borderColor = getContext().getResources().getColor(borderColorRes)"))
